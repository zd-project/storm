...
import static org.apache.storm.metric.StormMetricsRegistry.registerHistogram;
...
public class Nimbus implements Iface, Shutdownable, DaemonCommon {
    ...
    public static final Class<Nimbus> NIMBUS = Nimbus.class;
    private static final Logger LOG = LoggerFactory.getLogger(Nimbus.class);
    //    Metrics
    private static final Meter submitTopologyWithOptsCalls = registerMeter(name(NIMBUS, "num-submitTopologyWithOpts-calls"));
    private static final Meter submitTopologyCalls = registerMeter(name(NIMBUS, "num-submitTopology-calls"));
    private static final Meter killTopologyWithOptsCalls = registerMeter(name(NIMBUS, "num-killTopologyWithOpts-calls"));
    private static final Meter killTopologyCalls = registerMeter(name(NIMBUS, "num-killTopology-calls"));
    private static final Meter rebalanceCalls = registerMeter(name(NIMBUS, "num-rebalance-calls"));
    private static final Meter activateCalls = registerMeter(name(NIMBUS, "num-activate-calls"));
    private static final Meter deactivateCalls = registerMeter(name(NIMBUS, "num-deactivate-calls"));
    private static final Meter debugCalls = registerMeter(name(NIMBUS, "num-debug-calls"));
    private static final Meter setWorkerProfilerCalls = registerMeter(name(NIMBUS, "num-setWorkerProfiler-calls"));
    private static final Meter getComponentPendingProfileActionsCalls = registerMeter(
        name(NIMBUS, "num-getComponentPendingProfileActions-calls"));
    private static final Meter setLogConfigCalls = registerMeter(name(NIMBUS, "num-setLogConfig-calls"));
    private static final Meter uploadNewCredentialsCalls = registerMeter(name(NIMBUS, "num-uploadNewCredentials-calls"));
    private static final Meter beginFileUploadCalls = registerMeter(name(NIMBUS, "num-beginFileUpload-calls"));
    private static final Meter uploadChunkCalls = registerMeter(name(NIMBUS, "num-uploadChunk-calls"));
    private static final Meter finishFileUploadCalls = registerMeter(name(NIMBUS, "num-finishFileUpload-calls"));
    private static final Meter beginFileDownloadCalls = registerMeter(name(NIMBUS, "num-beginFileDownload-calls"));
    private static final Meter downloadChunkCalls = registerMeter(name(NIMBUS, "num-downloadChunk-calls"));
    private static final Meter getNimbusConfCalls = registerMeter(name(NIMBUS, "num-getNimbusConf-calls"));
    private static final Meter getLogConfigCalls = registerMeter(name(NIMBUS, "num-getLogConfig-calls"));
    private static final Meter getTopologyConfCalls = registerMeter(name(NIMBUS, "num-getTopologyConf-calls"));
    private static final Meter getTopologyCalls = registerMeter(name(NIMBUS, "num-getTopology-calls"));
    private static final Meter getUserTopologyCalls = registerMeter(name(NIMBUS, "num-getUserTopology-calls"));
    private static final Meter getClusterInfoCalls = registerMeter(name(NIMBUS, "num-getClusterInfo-calls"));
    private static final Meter getLeaderCalls = registerMeter(name(NIMBUS, "num-getLeader-calls"));
    private static final Meter isTopologyNameAllowedCalls = registerMeter(name(NIMBUS, "num-isTopologyNameAllowed-calls"));
    private static final Meter getTopologyInfoWithOptsCalls = registerMeter(
        name(NIMBUS, "num-getTopologyInfoWithOpts-calls"));
    private static final Meter getTopologyInfoCalls = registerMeter(name(NIMBUS, "num-getTopologyInfo-calls"));
    private static final Meter getTopologyPageInfoCalls = registerMeter(name(NIMBUS, "num-getTopologyPageInfo-calls"));
    private static final Meter getSupervisorPageInfoCalls = registerMeter(name(NIMBUS, "num-getSupervisorPageInfo-calls"));
    private static final Meter getComponentPageInfoCalls = registerMeter(name(NIMBUS, "num-getComponentPageInfo-calls"));
    private static final Histogram scheduleTopologyTimeMs = registerHistogram(name(NIMBUS, "time-scheduleTopology-ms"));
    private static final Meter getOwnerResourceSummariesCalls = registerMeter(
        name(NIMBUS, "num-getOwnerResourceSummaries-calls"));
    // END Metrics
    private static final Meter shutdownCalls = registerMeter(name(NIMBUS, "num-shutdown-calls"));
    private static final Meter processWorkerMetricsCalls = registerMeter(name(NIMBUS, "process-worker-metric-calls"));
    ...
    public void launchServer() throws Exception {
        try {
            ...
            registerGauge(name(NIMBUS, "num-supervisors"), () -> state.supervisors(null).size());
            registerGauge(name(NIMBUS, "fragmented-memory"), this::fragmentedMemory);
            registerGauge(name(NIMBUS, "fragmented-cpu"), this::fragmentedCpu);
            registerGauge(name(NIMBUS, "available-memory"), () -> nodeIdToResources.get().values()
                .parallelStream()
                .mapToDouble(SupervisorResources::getAvailableMem)
                .sum());
            registerGauge(name(NIMBUS, "available-cpu"), () -> nodeIdToResources.get().values()
                .parallelStream()
                .mapToDouble(SupervisorResources::getAvailableCpu)
                .sum());
            registerGauge(name(NIMBUS, "total-memory"), () -> nodeIdToResources.get().values()
                .parallelStream()
                .mapToDouble(SupervisorResources::getTotalMem)
                .sum());
            registerGauge(name(NIMBUS, "total-cpu"), () -> nodeIdToResources.get().values()
                .parallelStream()
